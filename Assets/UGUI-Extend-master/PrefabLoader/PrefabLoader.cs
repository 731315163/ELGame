    ...
    public class PrefabLoader : MonoBehaviour
    {
        ...
        static void ApplyAllPrefab(Transform root)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (loader != null && loader.mChild != null)
                {
                    ...
                    Object childPrefab = PrefabUtility.GetCorrespondingObjectFromSource(loaderGo);
                    if (childPrefab != null)
                    {
        ...
        void Update()
        {
            if (!Application.isPlaying)
            {
                if (source != null)
                {
                    Object selfPrefab = PrefabUtility.GetCorrespondingObjectFromSource(PrefabUtility.FindPrefabRoot(gameObject));
                    ...
                    if (mChild == null || PrefabUtility.GetCorrespondingObjectFromSource(mChild.gameObject) != source)
                    {
